...
# just load pv data
for pipeline_object in [simple_pv_datapipe, pv_nwp_satellite_data_pipeline, gsp_pv_nwp_satellite_data_pipeline]:
    pipeline = pipeline_object(configuration=file).set_length(5)
